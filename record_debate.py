...
async def main(ofrak_context: OFRAKContext, debate_archive_path: str):
    ...
    for i, question_path in enumerate(await zip_archive.list_dir()):
        ...
        await gradio_get_ai_voice(
            f"Questions/Question-{i}/Moderator.wav",
            question_raw.decode(),
            "voices/Ang_Cui.wav",
        )
        ...
        await gradio_get_ai_voice(
            f"Questions/Question-{i}/Trump.wav",
            trump_raw.decode(),
            "voices/Donald_Trump.wav",
        )
        ...
        await gradio_get_ai_voice(
            f"Questions/Question-{i}/Harris.wav",
            harris_raw.decode(),
            "voices/Kamala_Harris.wav",
        )
